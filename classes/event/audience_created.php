...
/**
 * IOMAD Custom page audience created event class.
 *
...
class audience_created extends base {
    ...
    /**
     * Creates an instance from a page audience object
     *
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' created an audience in the custom page with id '$pageid'.";
    }
